...
public class SwipeToUnfavoriteCallback extends ItemTouchHelper.SimpleCallback {
    private static final String TAG = "SwipeToDeleteCall";

    private CarbiesAdapter mAdapter;
    private Context mContext;

    public SwipeToUnfavoriteCallback(CarbiesAdapter adapter, Context context) {
    ...
    public void onSwiped(@NonNull RecyclerView.ViewHolder viewHolder, int direction) {
        ...
        mAdapter.unfavoriteItem(position);
